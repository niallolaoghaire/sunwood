...
class WC_Braintree_Hosted_Fields_Payment_Form extends WC_Braintree_Payment_Form {
	...
	protected function get_credit_card_fields() {
		...
		$fields['card-expiry']['label'] = esc_html__( 'Expiration (MMYY)', 'woocommerce-gateway-braintree' );
	...
	protected function get_payment_form_handler_js_params() {
		...
		return array(
			...
			'threeds'      => array(
				...
				'failure_message'                 => __( 'We cannot process your order with the payment information that you provided. Please use an alternate payment method.', 'woocommerce-gateway-braintree' ),
			),
